...
The **SPRAWL** can be any overcrowded megacity consumed by high tech, class struggle, intrusive advertising, corporatocracy, poor quality automated services, climate crash, the futile search for humanity amongst all this, and so on.
...
The **GAME MODERATOR (GM)** uses the game rules to establish a dynamic world around the PCs. They help organize the conversation so it’s pointed toward interesting elements of play.
